...
st.set_page_config(page_title="Preferences & Restrictions", layout="wide")
st.markdown("""
<style>
.navbar {
...
st.title("Preferences & Restrictions")
st.write("This is the preferences & restrictions screen.")
