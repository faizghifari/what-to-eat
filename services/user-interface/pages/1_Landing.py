...
st.set_page_config(page_title="What To Eat Landing Page", layout="wide")
st.markdown("""
<style>
.navbar {
...
st.title("What To Eat Landing Page")
st.write("This is the what to eat landing page screen.")
